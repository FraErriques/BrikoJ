 ...
 * @author admin
 */
public class Jprime extends javax.swing.JFrame {
    ...
    private void mnu_FSproductionActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void mnu_enrichDBMouseReleased(java.awt.event.MouseEvent evt) {                                           
        // TODO add your handling code here:
        ...
        for(int c=0; c<2; c++)
        {
            PrimeThreadForker theForker = new PrimeThreadForker();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jprime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
