 ...
 * @author admin
 */
public class Frechet_PostgreSql_Prime_INSERT_ implements Runnable
{
    public javax.swing.JTextArea local_txtClipboard;
    Connection con;
    
    //Ctor
    public Frechet_PostgreSql_Prime_INSERT_(javax.swing.JTextArea txtClipboard, Connection con)
    {
